...
\usepackage{setspace}%line spacingk
...
\iftoggle{develop}{ 
	...
	\gambar{yes}\tabel{no} 
	\bab{1,2}\lampiran{A} 
	\namanpm{ALDY MARCELLINO CHRISTIAN}{2013730005}\tanggal{1}{8}{2002}
	\pembimbing{\BSB}{}\penguji{\TAB}{\LNV}
	\judulINA{Mencari Solusi untuk Persamaan Diferensial dengan Menggunakan Algoritma Genetik}
	\judulENG{Finding Solutions for Differential Equations by Using Genetic Algorithm}
	...
	\untuk{Pain is temporary, glory is eternal\ldots?}
